return {
  ...
  keys = {
    ...
    { '<leader>F<space>', function() Snacks.picker() end, desc = "[F<space>]: Open picker for all commands" },
    ...
    { "<leader>s_", function() Snacks.picker.lazygit() end, desc = "Search for Plugin Spec" },
