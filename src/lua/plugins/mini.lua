return {
  ...
  -- TODO: separate into separate configs
  'mini.nvim',
  lazy = false,
  keys = {
    -- move
    { 'mh', ':lua require("mini.move").move_selection("left")<cr>'     , '[m]ove selection left [h]', mode = 'v' },
    { 'ml', ':lua require("mini.move").move_selection("right")<cr>'    , '[m]ove selection [r]ight',  mode = 'v' },
    { 'mj', ':lua require("mini.move").move_selection("down")<cr>'     , '[m]ove selection [d]own', mode = 'v' },
    { 'mk', ':lua require("mini.move").move_selection("up")<cr>'       , '[m]ove selection up [k]', mode = 'v' },

    { '<leader>mh', ':lua require("mini.move").move_line("left")<cr>'  , '[m]ove line left [h]' },
    { '<leader>ml', ':lua require("mini.move").move_line("right")<cr>' , '[m]ove line [r]ight' },
    { '<leader>mj', ':lua require("mini.move").move_line("down")<cr>'  , '[m]ove line [d]own' },
    { '<leader>mk', ':lua require("mini.move").move_line("up")<cr>'    , '[m]ove line up [k]' },
  ...
  after = function(_, opts)
    ...
    -- starter
    if nixInfo(false, 'settings', 'mini', 'startpage') then
